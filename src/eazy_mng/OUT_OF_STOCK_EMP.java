 ...
 */
public class OUT_OF_STOCK_EMP extends javax.swing.JFrame {
       String time = null;
     String date = null;
     ...
     */
    public OUT_OF_STOCK_EMP() {
        initComponents();
        auto();
    }
     void oos (String fullname, String emp_Id,String email,String t1,String d1,String p) {
      Name = fullname;
        Id = emp_Id;
        emll = email;
        time = t1;
            ...
            
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OUT_OF_STOCK_EMP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OUT_OF_STOCK_EMP().setVisible(true);
            }
        });
    }
