 ...
 */
public class SEARCH_PRODUCT_EMP extends javax.swing.JFrame {
String time = null;
     String date = null;
     String ph = null;
     String Name = null;
     ...
     */
    public SEARCH_PRODUCT_EMP() {
        initComponents();
        table();
        search();
    }
   void sp (String fullname, String emp_Id,String email,String t1,String d1,String p) {
        Name = fullname;
        Id = emp_Id;
        emll = email;
        time = t1;
     ...
     public void table()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SEARCH_PRODUCT_EMP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SEARCH_PRODUCT_EMP().setVisible(true);
            }
        });
    }
