 ...
 */
public class PRODUCT_LOST_EMP extends javax.swing.JFrame {
    ...
    public PRODUCT_LOST_EMP() {
     ...
     void pl (String fullname, String emp_Id,String email,String t1,String d1,String p) {
        Name = fullname;
        Id = emp_Id;
        emll = email;
        time = t1;
...
public void cal(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRODUCT_LOST_EMP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PRODUCT_LOST_EMP().setVisible(true);
            }
        });
    }
