 ...
 * @author Sudip Maiti
 */
public class SELL_TARGET_EMP extends javax.swing.JFrame {
String ph = null;
     String Name = null;
     String Id = null;
     String emll = null;
     ...
     */
    void ste (String fullname, String emp_Id,String email,String t1,String d1,String p) {
      Name = fullname;
        Id = emp_Id;
        emll = email;
        time = t1;
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Who Gave ", "Date", "Time", "Product ID", "Product Name", "From Date", "To Date", "Quantity", "Description"
            }
        ) {
        ...
        jLabel7.setText("Describe Target :");
    ...
    public void table()
{
   ...
   // System.out.println("hello"+Id);
           ...
           while (rs.next())
           {
               ...
               Object o []={
                  // Manager_Name, Manager_id, Date,Time, Employee_Name, ,Employee_Phone,Employee_email,Complain
                   rs.getString("MANAGER_NAME"),rs.getString("DATE"),rs.getString("TIME"),rs.getString("PRODUCT_ID"),rs.getString("PRODUCT_NAME"),rs.getString("FROM_DATE"),rs.getString("TO_DATE"),rs.getString("QUANTITY"),rs.getString("DESCRIPTION")};
                   model.addRow(o);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
     ...
     DefaultTableModel model=(DefaultTableModel)table.getModel();
     String find = model.getValueAt(i,1).toString();
     String find1 = model.getValueAt(i,2).toString();
     try {
        
             //Data fetch from database
            String sql1 = "Select * from sales_target1 Where DATE = ? And TIME =?";
            ...
            if(rs1.next()){
                ...
                String f_name =rs1.getString("DESCRIPTION");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SELL_TARGET_EMP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SELL_TARGET_EMP().setVisible(true);
            }
        });
    }
